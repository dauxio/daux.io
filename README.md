...
Copy the files from the repo to a web server that can run PHP 8.4.0 or newer.
...
Daux.io is compatible with the [officially supported](https://www.php.net/supported-versions.php) PHP versions; 8.4.0 and up.
